...
public class AnswerShapeDrawableSurfaceView extends SurfaceView implements
		SurfaceHolder.Callback, ChooseItemViewInterface {
	...
	public AnswerShapeDrawableSurfaceView(Context context, AttributeSet attrs) {
		super(context, attrs);
