...
public class GameFactory {
	...
	public static Game getGame(String type, Iterator<String> tags, Object view, String question) throws InvalidViewTypeException, MissingTagException, GameDoesNotExistException{
